...
- Fix peer deps issue
- Upgraded to Tailwind v4 and fix line height issue
- Refactored docs pages
- Updated markups on blog cards
- Using tailwind typography plugin for blogs and docs pages styling
