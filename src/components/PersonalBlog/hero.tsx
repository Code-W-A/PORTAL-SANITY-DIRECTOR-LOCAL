import { getAuthorBySlug, imageBuilder } from "@/sanity/sanity-utils";
import Image from "next/image";

const Hero = async () => {
  const author = await getAuthorBySlug("ryna-kenter");
  ...
  return (
    <section>
      <div className="mx-auto max-w-[1170px] px-4 pt-34 pb-12.5 sm:px-8 xl:px-0">
        <div className="relative z-10 overflow-hidden rounded-[20px]">
          {/* <!-- Hero BG Shapes Start --> */}
          <div>
            <div className="bg-gray absolute bottom-0 left-0 h-full w-full rounded-[20px]"></div>
          ...
          <div className="relative z-1 mx-auto max-w-[880px] px-4 py-7.5 sm:px-8 sm:py-10 lg:px-0 lg:py-15">
            <div className="flex flex-col items-center gap-7.5 sm:flex-row lg:gap-15">
              <div className="border-gray-3 flex h-[277px] w-full max-w-[277px] items-center justify-center rounded-full border">
                <div className="shadow-img h-[165px] w-full max-w-[165px] overflow-hidden rounded-full">
                  <Image
              ...
              <div className="w-full max-w-[593px]">
                <h1 className="text-dark lg:text-heading-3 xl:text-heading-2 mb-3.5 text-2xl sm:text-4xl">
                  Hey! I&apos;m <span className="font-bold">{author.name}</span>
                </h1>
                ...
                <div className="mt-7 flex items-center gap-5">
                  <a
                    href="#"
                    className="hover:text-dark flex lg:transition-all lg:duration-300 lg:ease-linear"
                  >
                    <svg
