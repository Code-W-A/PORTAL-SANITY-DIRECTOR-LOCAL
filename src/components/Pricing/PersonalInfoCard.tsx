  ...
  return (
    <div className="max-w-[520px] px-4 sm:px-8 xl:px-0">
      ...
      <button
        ...
        className="border-gray-4 text-dark hover:border-gray-5 hover:bg-gray flex w-full items-center justify-center gap-2.5 rounded-lg border p-3.5 duration-200 ease-in"
      >
        <svg
          width="23"
          height="22"
      ...
      <button
        ...
        className="border-gray-4 text-dark hover:border-gray-5 hover:bg-gray mt-4 flex w-full items-center justify-center gap-2.5 rounded-lg border p-3.5 duration-200 ease-in"
      >
        <svg
          width="22"
          height="22"
      ...
      <span className="text-custom-sm relative mt-9 block text-center">
        <span className="bg-gray-3 absolute top-1/2 left-0 block h-px w-full max-w-30"></span>
        <span className="bg-gray-3 absolute top-1/2 right-0 block h-px w-full max-w-30"></span>
