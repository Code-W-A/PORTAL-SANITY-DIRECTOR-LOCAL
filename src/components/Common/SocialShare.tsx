      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="flex h-7.5 w-7.5 items-center justify-center rounded-full bg-[#364E8F] duration-300 ease-in hover:bg-[#364E8F]/95"
          >
            <svg
              width="14"
              height="14"
          ...
          <Link
            ...
            className="flex h-7.5 w-7.5 items-center justify-center rounded-full bg-[#52A2EC] duration-300 ease-in hover:bg-[#52A2EC]/95"
          >
            <svg
              width="14"
              height="14"
          ...
          <Link
            ...
            className="flex h-7.5 w-7.5 items-center justify-center rounded-full bg-[#B1151D] duration-300 ease-in hover:bg-[#B1151D]/95"
          >
            <svg
              width="14"
              height="14"
